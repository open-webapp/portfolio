...
- `Settings.tsx` "Quotes API Key" tab (fourth `.seg-opt`, alongside Drive/Import-Export/Encryption; internal `settingsSection` value still `'priceSync'`) — single card with two sub-blocks:
