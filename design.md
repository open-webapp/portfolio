...
src/
  ...
  lib/
    ...
    drive.ts                 # drive-sync singleton + syncBackup/restoreBackup/restoreBackupFromFileId/getBackupFileId/extractDriveFileId, DriveDecryptError
  ...
  components/
    ...
    DriveRestorePanel.tsx        # shared Drive connect/disconnect/restore UI: connect button, disconnect link, restore from Drive button, cross-password retry prompt, no-backup paste-URL fallback; used by both PasswordGate restore tab and SettingsPage
